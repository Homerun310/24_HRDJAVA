...
public class vocatest_hard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            private void checkAnswer() {
                ...
                int selectedAnswerNo = radioGroup.indexOfChild(rbSelected) + 1;
    ...
    private List<Question> createQuestionList() {
        ...
        // 샘플 문제들 추가
        questions.add(new Question("What is the capital of Korea?", "Seoul", "Madrid", "Paris", "Rome", 1));
        questions.add(new Question("What is the capital of Spain?", "Lisbon", "Madrid", "Rome", "Berlin", 2));
        questions.add(new Question("Which is the largest planet?", "Earth", "Mars", "Jupiter", "Saturn", 3));
        questions.add(new Question("Who wrote 'Hamlet'?", "Dickens", "Shakespeare", "Hemingway", "Austen", 2));
